...
- US-27  English and Spanish UI          ← antes de cualquier componente UI
...
**Acceptance Criteria:**
- The project compiles and launches an empty window on Windows, Linux, and macOS.
...
- Create placeholder files for all modules defined in the project tree (`engine/`, `schema/`, `stores/`, `components/`).
