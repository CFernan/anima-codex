...
export const HabilidadesDeCombateSchema = z.object({
  ...
  tablas_de_armas:    z.array(PdConOpcionesSchema).optional(),

  /** Style tables purchased. */
  tablas_de_estilos:  z.array(PdConOpcionesSchema).optional(),
